(() => {
  ...
  const MENU_DATA = [
    { tFr: 'Les planches', tEn: 'Boards', nFr: '', nEn: '', items: [
      { name: 'Planche mixte', nameEn: 'Mixed board', fr: 'Jambon, comté, camembert, rostelle, andouille, coppa, saucisson, jambon de pays italien.', en: 'Ham, comté, camembert, rostelle, andouille, coppa, salami, Italian country ham.', p: 18.50 },
      { name: 'Planche de tapas', nameEn: 'Tapas board', fr: 'Guacamole, houmous, doritos, accras, calamars frits.', en: 'Guacamole, hummus, tortilla chips, accras, fried squid.', p: 18.50 },
    ]},
    { tFr: 'Les entrées', tEn: 'Starters', nFr: '', nEn: '', items: [
      { name: 'Soupe de poisson maison', nameEn: 'Home-made fish soup', fr: 'Croûtons et rouille.', en: 'Croutons and rouille.', p: 14.90 },
      { name: 'Rillettes de maquereau et ses toasts', nameEn: 'Mackerel rillettes with toast', fr: '', en: '', p: 13.00 },
      { name: 'Tataki de thon et sa salade thaï', nameEn: 'Tuna tataki & Thai salad', fr: '', en: '', p: 18.50 },
      { name: 'Assiette de foie gras', nameEn: 'Foie gras plate', fr: '', en: '', p: 18.00 },
    ]},
    { tFr: 'Les fruits de mer', tEn: 'Seafood', nFr: '', nEn: '', items: [
      { name: 'Assiette de bulots / aïoli', nameEn: 'Whelks with aïoli', fr: '', en: '', p: 13.00 },
      { name: 'Assiette de 8 crevettes BIO Madagascar', nameEn: '8 organic Madagascar prawns', fr: '', en: '', p: 22.00 },
      { name: 'Assiette 6 huîtres, 6 crevettes, 8 bulots', nameEn: '6 oysters, 6 prawns, 8 whelks', fr: '', en: '', p: 32.00 },
      { name: 'Duo 6 crevettes et 8 bulots', nameEn: '6 prawns & 8 whelks', fr: '', en: '', p: 20.00 },
      { name: 'Duo 6 crevettes et 6 huîtres', nameEn: '6 prawns & 6 oysters', fr: '', en: '', p: 22.00 },
    ]},
    { tFr: 'Les huîtres de Lanmodez N° 3', tEn: 'Lanmodez Oysters N° 3', nFr: '', nEn: '', items: [
      { name: 'Les 6', nameEn: '6 oysters', fr: '', en: '', p: 12.00 },
      { name: 'Les 9', nameEn: '9 oysters', fr: '', en: '', p: 18.00 },
      { name: 'Les 12', nameEn: '12 oysters', fr: '', en: '', p: 23.00 },
    ]},
    { tFr: 'Les grandes salades', tEn: 'Large salads', nFr: '', nEn: '', items: [
      ...
      { name: 'La salade Lo Soli', nameEn: 'Lo Soli salad', fr: 'Salades mélangées, lardons déglacés, tomate, œuf, coppa, pignons de pin, noix, toast aux fromages, vinaigrette noix/framboises.', en: 'Mixed leaves, pan-fried lardons, tomato, egg, coppa, pine nuts, walnuts, cheese toast, walnut and raspberry dressing.', p: 22.00 },
      { name: 'La "façon" César', nameEn: 'Caesar-style salad', fr: 'Poulet, croûtons, iceberg, œuf, tomate, parmesan, sauce maison.', en: 'Chicken, croutons, iceberg, egg, tomato, parmesan, house sauce.', p: 19.90 },
    ...
    { tFr: 'Les burgers et viandes', tEn: 'Burgers & meats', nFr: '', nEn: '', items: [
      ...
      { name: 'Tartare de bœuf', nameEn: 'Beef tartare', fr: 'Non préparé, 180 g, frites et salade.', en: 'Unprepared, 180g, fries and salad.', p: 19.90 },
      { name: "L'entrecôte", nameEn: 'Sirloin steak', fr: '300 g VBF, sauce maison, frites et salade.', en: '300g VBF sirloin, house sauce, fries and salad.', p: 28.00 },
      { name: 'Filet de bœuf Rossini', nameEn: 'Beef tenderloin Rossini', fr: 'Gratin dauphinois et légumes.', en: 'Dauphinoise gratin and vegetables.', p: 29.00 },
      { name: 'Mix grillé de 4 viandes', nameEn: 'Mixed grill (4 meats)', fr: 'Sauce béarnaise ou piperade, frites et salade.', en: 'Béarnaise or piperade sauce, fries and salad.', p: 29.00 },
      { name: 'Côte de bœuf à partager', nameEn: 'Côte de bœuf to share', fr: 'Environ 1,2 kg VBF.', en: 'Around 1.2 kg VBF.', p: 79.00 },
      { name: 'Bavette de bœuf sauce échalotes', nameEn: 'Skirt steak, shallot sauce', fr: '200 g VBF, frites et salade.', en: '200g VBF, fries and salad.', p: 21.50 },
      { name: "Épaule d'agneau confite", nameEn: 'Slow-cooked lamb shoulder', fr: 'Comme un couscous.', en: 'Couscous style.', p: 28.00 },
      { name: "Souris d'agneau", nameEn: 'Lamb shank', fr: 'Écrasé de légumes, miel, romarin.', en: 'Vegetable crush, honey and rosemary.', p: 25.00 },
    ]},
    { tFr: 'Suppléments', tEn: 'Extras', nFr: '', nEn: '', items: [
      { name: 'Sauce maison', nameEn: 'House sauce', fr: "Poivre vert, roquefort, béarnaise, beurre maître d'hôtel, compotée d'échalotes.", en: "Green pepper, roquefort, béarnaise, maître d'hôtel butter, shallot compote.", p: 2 },
      { name: 'Frites ou salade', nameEn: 'Fries or salad', fr: '', en: '', p: 4 },
    ]},
    { tFr: 'Les woks', tEn: 'Woks', nFr: '', nEn: '', items: [
      { name: 'Wok végétarien', nameEn: 'Vegetarian wok', fr: '', en: '', p: 22.00 },
      { name: 'Wok de bœuf', nameEn: 'Beef wok', fr: '', en: '', p: 26.90 },
      { name: 'Wok de poulet', nameEn: 'Chicken wok', fr: '', en: '', p: 26.90 },
      { name: 'Wok de gambas', nameEn: 'King prawn wok', fr: '', en: '', p: 26.90 },
    ]},
    { tFr: 'Les poissons et spécialités', tEn: 'Fish & specialities', nFr: '', nEn: '', items: [
      ...
      { name: 'Saint-Jacques rôties, armoricaine risotto', nameEn: 'Roasted scallops, armoricaine risotto', fr: '', en: '', p: 27.00 },
      { name: 'Steak de thon grillé', nameEn: 'Grilled tuna steak', fr: 'Sauce thaï, riz et légumes wok.', en: 'Thai sauce, rice and wok vegetables.', p: 28.00 },
      { name: 'La Cotriade', nameEn: 'La Cotriade', fr: 'Soupe maison, trois poissons, gambas et légumes.', en: 'Home-made fish stew, three fish, king prawns and vegetables.', p: 29.50 },
      { name: 'Tajine de lotte au citron et au safran', nameEn: 'Monkfish tagine, lemon & saffron', fr: 'Semoule et légumes.', en: 'Couscous and vegetables.', p: 29.00 },
    ]},
    { tFr: 'Les moules frites', tEn: 'Mussels & fries', nFr: '400 g', nEn: '400g', items: [
      { name: 'Moules marinières', nameEn: 'Marinière mussels', fr: '', en: '', p: 18.90 },
      { name: 'Moules à la crème', nameEn: 'Cream mussels', fr: '', en: '', p: 19.90 },
      { name: 'Moules au roquefort', nameEn: 'Roquefort mussels', fr: '', en: '', p: 20.90 },
      { name: 'Moules à la normande', nameEn: 'Normande mussels', fr: '', en: '', p: 20.90 },
    ]},
    { tFr: 'Les pizzas · pâte maison · base tomate', tEn: 'Pizzas · home-made dough · tomato base', nFr: '', nEn: '', items: [
      ...
      { name: 'Quatre saisons', nameEn: 'Four seasons', fr: 'Jambon, champignons, anchois, câpres.', en: 'Ham, mushrooms, anchovies, capers.', p: 16.90 },
      ...
      { name: 'Quatre fromages', nameEn: 'Four cheeses', fr: 'Mozzarella, comté, roquefort, chèvre.', en: 'Mozzarella, comté, roquefort, goat cheese.', p: 17.90 },
      ...
      { name: 'Chèvre miel', nameEn: 'Goat cheese & honey', fr: 'Fromage de chèvre, miel, roquette.', en: 'Goat cheese, honey, rocket.', p: 16.90 },
      { name: 'Indienne', nameEn: 'Indian', fr: 'Poulet tandoori, oignons, poivrons, crème fraîche.', en: 'Tandoori chicken, onions, peppers, crème fraîche.', p: 20.50 },
      { name: 'Frutti di mare', fr: 'Fruits de mer, ail, persil.', en: 'Seafood, garlic, parsley.', p: 20.90 },
      { name: 'Végétarienne', nameEn: 'Vegetarian', fr: 'Légumes grillés, mozzarella.', en: 'Grilled vegetables, mozzarella.', p: 17.00 },
      { name: 'Supplément garniture', nameEn: 'Extra topping', fr: 'Sauf burrata.', en: 'Except burrata.', p: 2 },
      { name: 'Pizza mixte', nameEn: 'Half-and-half pizza', fr: '½ pizza au choix + salade de crudités.', en: 'Half pizza of your choice + crudités salad.', p: 16.90 },
    ]},
    { tFr: 'Les pizzas blanches · base crème fraîche', tEn: 'White pizzas · crème fraîche base', nFr: '', nEn: '', items: [
      { name: 'Paysanne', nameEn: 'Country-style', fr: 'Lardons, oignons, pommes de terre.', en: 'Lardons, onions, potatoes.', p: 17.50 },
    ...
    { tFr: 'Menu enfant', tEn: "Children's menu", nFr: '13,90 €', nEn: '13.90 €', items: [
      { name: 'Boisson', nameEn: 'Drink', fr: 'Jus de fruits, sirop ou diabolo.', en: 'Fruit juice, syrup or diabolo.' },
      { name: 'Plat', nameEn: 'Main', fr: 'Pizza bambino, jambon-frites, moules frites ou mini chicken burger.', en: 'Bambino pizza, ham and fries, mussels and fries, or mini chicken burger.' },
      { name: 'Dessert', fr: 'Glace pop-up ou crêpe.', en: 'Ice lolly or crêpe.' },
    ]},
    { tFr: 'Les desserts maisons', tEn: 'Home-made desserts', nFr: '', nEn: '', items: [
      { name: 'Assortiment 4 fromages', nameEn: 'Cheese selection', fr: '', en: '4 varieties.', p: 11 },
      { name: 'Café gourmand', nameEn: 'Coffee & mini desserts', fr: '', en: '', p: 11 },
      { name: 'Moelleux chocolat', nameEn: 'Chocolate fondant', fr: '', en: '', p: 9 },
      { name: 'Kouign-amann', fr: '', en: '', p: 9 },
      { name: 'Mousse au chocolat', nameEn: 'Chocolate mousse', fr: '', en: '', p: 8 },
      { name: 'Tarte aux fruits du jour', nameEn: "Today's fruit tart", fr: '', en: '', p: 9 },
      { name: 'Fraises chantilly', nameEn: 'Strawberries & chantilly', fr: '', en: '', p: 8 },
    ]},
  ...
  const T = {
    fr: {
      ...
      h_break_t: 'Petit-déjeuner', h_break_v: '9h – 12h · juillet & août',
      h_lunch_t: 'Déjeuner', h_lunch_v: '12h – 15h',
      h_dinner_t: 'Dîner', h_dinner_v: '19h – 22h',
      ...
      formule: 'Formule petit-déjeuner · 9h–12h · juillet & août · 10 €',
      ...
      legal_editor_h: 'Éditeur du site',
      legal_editor_p: "Le site lo-soli.fr est édité par la société PIERRE & CO, SARL immatriculée au Registre du Commerce et des Sociétés de Saint-Brieuc.\n\nNom commercial : Lo Soli\nSiège social : Plage de Trestraou – 17 Boulevard Joseph Le Bihan, 22700 Perros-Guirec\nTéléphone : 02 96 91 14 69\nSIREN : 952 103 547\nSIRET : 952 103 547 00024\nN° TVA intracommunautaire : FR56 952 103 547\nRCS Saint-Brieuc : 952 103 547\nActivité : Restauration traditionnelle (code APE 56.10A)",
      legal_pub_h: 'Directeur de la publication',
      legal_pub_p: 'Le directeur de la publication est M. Luc Griboualrd, en qualité de gérant.',
      legal_host_h: 'Hébergement',
      legal_host_p: 'Le site est hébergé par Vercel Inc., 440 N Barranca Avenue #4133, Covina, CA 91723, États-Unis (vercel.com).',
      legal_ip_h: 'Propriété intellectuelle',
      legal_ip_p: "L'ensemble du contenu du site (textes, photographies, illustrations, logo, mise en page) est protégé par le droit d'auteur et le droit des marques. Toute reproduction, représentation ou exploitation, totale ou partielle, sans autorisation écrite préalable de PIERRE & CO est interdite.",
      legal_data_h: 'Données personnelles',
      legal_data_p: "Conformément au Règlement (UE) 2016/679 (RGPD) et à la loi « Informatique et Libertés », vous disposez d'un droit d'accès, de rectification, d'effacement, de limitation, d'opposition et de portabilité concernant vos données personnelles.\n\nLe site ne collecte pas de données via formulaire en ligne. Les réservations s'effectuent par téléphone. Seule la préférence de langue (français / anglais) peut être enregistrée localement dans votre navigateur (localStorage), sans transmission à des tiers.\n\nPour exercer vos droits ou pour toute question relative à vos données, contactez-nous au 02 96 91 14 69.\n\nPour en savoir plus sur vos droits, consultez le site de la CNIL : cnil.fr",
      legal_cookies_h: 'Cookies et traceurs',
      legal_cookies_p: "Le site n'utilise pas de cookies publicitaires ni de mesure d'audience. Seul un stockage local (localStorage) peut enregistrer votre choix de langue. Des contenus tiers (Google Fonts, OpenStreetMap sur la page Contact, liens vers Instagram) peuvent déposer des traceurs selon leurs propres politiques.",
      legal_credits_h: 'Crédits',
      legal_credits_p: 'Les photographies et visuels du site appartiennent à Lo Soli / PIERRE & CO ou sont utilisés avec autorisation. Les polices de caractères sont fournies par Google Fonts.',
      legal_law_h: 'Droit applicable',
      legal_law_p: 'Le présent site est soumis au droit français. En cas de litige, et à défaut de résolution amiable, les tribunaux compétents du ressort de Saint-Brieuc seront seuls compétents.',
      values: [
    ...
    en: {
      ...
      h_break_t: 'Breakfast', h_break_v: '9am – 12pm · Jul & Aug',
      h_lunch_t: 'Lunch', h_lunch_v: '12 – 3pm',
      h_dinner_t: 'Dinner', h_dinner_v: '7 – 10pm',
      ...
      formule: 'Breakfast set · 9am–12pm · Jul & Aug · €10',
      ...
      legal_kicker: 'Legal information',
      legal_title: 'Legal notice',
      legal_updated: 'Last updated: August 2026',
      legal_editor_h: 'Site publisher',
      legal_editor_p: "The lo-soli.fr website is published by PIERRE & CO, a French limited liability company (SARL) registered with the Trade and Companies Register of Saint-Brieuc.\n\nTrading name: Lo Soli\nRegistered office: Plage de Trestraou – 17 Boulevard Joseph Le Bihan, 22700 Perros-Guirec, France\nPhone: +33 2 96 91 14 69\nSIREN: 952 103 547\nSIRET: 952 103 547 00024\nEU VAT number: FR56 952 103 547\nRCS Saint-Brieuc: 952 103 547\nActivity: Traditional restaurant (NAF code 56.10A)",
      legal_pub_h: 'Publication director',
      legal_pub_p: 'The publication director is Mr Luc Griboualrd, in his capacity as managing director.',
      legal_host_h: 'Hosting',
      legal_host_p: 'This website is hosted by Vercel Inc., 440 N Barranca Avenue #4133, Covina, CA 91723, United States (vercel.com).',
      legal_ip_h: 'Intellectual property',
      legal_ip_p: 'All website content (text, photographs, illustrations, logo and layout) is protected by copyright and trademark law. Any reproduction, representation or use, in whole or in part, without prior written consent from PIERRE & CO is prohibited.',
      legal_data_h: 'Personal data',
      legal_data_p: "In accordance with Regulation (EU) 2016/679 (GDPR) and the French Data Protection Act, you have the right to access, rectify, erase, restrict, object to and port your personal data.\n\nThis website does not collect data through online forms. Bookings are made by phone. Only your language preference (French / English) may be stored locally in your browser (localStorage), with no transmission to third parties.\n\nTo exercise your rights or ask any question about your data, call us on +33 2 96 91 14 69.\n\nFor more information about your rights, visit the CNIL website: cnil.fr",
      legal_cookies_h: 'Cookies and trackers',
      legal_cookies_p: 'This website does not use advertising cookies or audience measurement tools. Only local storage (localStorage) may save your language choice. Third-party content (Google Fonts, OpenStreetMap on the Contact page, links to Instagram) may place trackers under their own policies.',
      legal_credits_h: 'Credits',
      legal_credits_p: 'Photographs and visuals on this website belong to Lo Soli / PIERRE & CO or are used with permission. Fonts are provided by Google Fonts.',
      legal_law_h: 'Applicable law',
      legal_law_p: 'This website is governed by French law. In the event of a dispute, and failing an amicable settlement, the courts within the jurisdiction of Saint-Brieuc shall have exclusive authority.',
      values: [
        ...
        ${sec.items.map(it => `
          <div class="menu-item">
            <div class="menu-item-info">
              <p class="menu-item-name">${fr ? it.name : (it.nameEn || it.name)}${it.star ? '<span class="menu-item-star">★</span>' : ''}</p>
